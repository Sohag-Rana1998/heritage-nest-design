    ...
    <Link to={`/property-details/${property._id}`}>
      <div className=" w-full h-auto">
        <div className="bg-black h-52 relative">
          ...
          <span className="bg-[#FDF0E7] px-2 py-1 rounded-md absolute left-3 bottom-3 flex items-center gap-2 ">
            <BsImage className="text-xl text-[#EE6611] font-bold" /> 20
          </span>
        </div>
        <div className="bg-[#F9FAFB] p-4">
          <div className="flex justify-between items-center mb-3">
            <span className="text-sm font-semibold px-2 py-1 bg-[#C5E2FF] rounded-md">
              Apartment{" "}
            </span>
